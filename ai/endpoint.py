...
async def process_video(
    ...
    try:
        ...
        return {
            ...
            "evaluation": '{\n  "errors": [\n    "0: Didn\'t mention the specific Slide title \'Mosquito Research: Saving Lives with Pantyhose and Paperclips\'",\n    "0: Deviated from the ground truth by combining the introduction with the project title inaccurately",\n    "Her presentation title is Mosquito research, saving",\n    "Forgot to mention \'The deadliest animal on the planet is not a large predator but the small mosquito\'",\n    "20: Incomplete sentence, didn\'t contextualize \'panty hose and paper clips\'",\n    "80: Diverged from the ground truth, non-specific information about \'Australian audience members thinking ruth, Science\'",\n    "Caught 20,000 mosquitoes - didn\'t connect to broader environmental analysis purpose",\n    "120: Missed \'Ross river virus, bar forest virus, and\'",\n    "Presented \'findings\' but not clearly linked to \'Slide 6 results and impact\'"\n  ],\n  "recommendations": [\n    "0: Clearly state the slide title and presenter details at the beginning for coherence.",\n    "20: Ensure complete sentences and clearly explain the mention of \'panty hose and paper clips\'.",\n    "40: Include more data-driven content as seen in \'Slide 2\'",\n    "80: Avoid making obscure references like \'thinking ruth, Science\'; instead, focus on direct information pertaining to the research.",\n    "100: Clarify how the research specifically impacts Australian mosquitoes related diseases and link to environmental hotspots comprehensively.",\n    "120: Explicitly mention the three viruses identified and their importance.",\n    "140: When discussing field work, emphasize the purpose and impact of data collected on human housing density and green space.",\n    "160: Link practical findings directly to public health applications.",\n    "180: Maintain consistency between verbal presentation and visual slides, avoiding omitted slides or incomplete explanations.",\n    "180: Body language is positive; consistently use hand gestures to emphasize points as observed at 120-second mark."\n  ]\n}',
        }
